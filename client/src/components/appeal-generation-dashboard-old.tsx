...
import { AlertTriangle, TrendingUp, FileText, Clock, CheckCircle, Target, Stethoscope, Activity, TestTube, Pill, Search } from "lucide-react";
                ...
                <TableRow key={appealCase.id}>
                  ...
                  <TableCell>
                    <Button
                      ...
                      size="sm"
                      onClick={() => {
                        // Transform AppealCase to denial format for consistency
                        const denial = {
