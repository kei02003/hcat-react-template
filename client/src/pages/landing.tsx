...
export default function Landing() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#006d9a]/10 to-[#6e53a3]/10">
      {/* Header */}
      <div className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              <Activity className="h-8 w-8 text-[#006d9a]" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 sm:text-5xl md:text-6xl">
            Advanced Healthcare
            <span className="text-[#006d9a]"> Revenue Cycle Management</span>
          </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <Card className="healthcare-card hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              <div className="flex items-center mb-4">
                <AlertTriangle className="h-8 w-8 text-[#f13c45]" />
          ...
          <Card className="healthcare-card hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              <div className="flex items-center mb-4">
                <TrendingUp className="h-8 w-8 text-[#006d9a]" />
                <h3 className="ml-3 text-xl font-semibold text-gray-900">
          ...
          <Card className="healthcare-card hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              <div className="flex items-center mb-4">
                <Clock className="h-8 w-8 text-[#f8961d]" />
                <h3 className="ml-3 text-xl font-semibold text-gray-900">
                  Timely Filing
                </h3>
              </div>
      ...
      <div className="bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {[
              { role: "System Admin", color: "bg-[#f13c45]/20 text-[#f13c45]/95", level: "Full Access" },
              ...
              { role: "Denial Specialist", color: "bg-[#f8961d]/20 text-[#f8961d]/95", level: "Denial Focus" },
      ...
      <div className="bg-[#006d9a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-[#006d9a]/20">
            ...
            <div className="mt-8">
              <Button 
                onClick={() => window.location.href = "/api/login"}
                size="lg"
                className="bg-white text-[#006d9a] hover:bg-gray-100"
              >
                <Shield className="h-4 w-4 mr-2" />
